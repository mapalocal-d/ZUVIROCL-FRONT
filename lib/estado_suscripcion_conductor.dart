...
class _EstadoSuscripcionConductorScreenState
    ...
    try {
      ...
      if (resp.statusCode == 200) {
        ...
        if (urlPago != null) {
          ...
          // Aquí puedes abrir el enlace con url_launcher
          // await launchUrl(Uri.parse(urlPago));
        } else {
          _mostrarMensaje('✅ Renovación procesada exitosamente.');
        }

        // Recargar estado después de renovar
        await _cargarEstado();
      } else {
        final body = jsonDecode(resp.body);
  ...
  bool get _puedeRenovar {
    ...
    // Puede renovar si está vencida o si le quedan pocos días
